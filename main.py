...
def Geenrate_MIS_Report():
    ...
    RM_name=st.selectbox("Select the RM",options=['rahul m v','mudit','chandan b r','ashish lal','arun mathew','binto sebastian','ratheesh nambiar','manju - suhas','khushboo seth'])
