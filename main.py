...
def Geenrate_MIS_Report():
    ...
    RM_name=st.selectbox("Select the RM",options=['rahul m v','mudit','chandan b r','arun mathew','binto sebastian','ratheesh nambiar'])
    ...
    with st.container(border=True):
      ...
      with col1:
       ...
       filtered_df_smallcase['Invested Amount'] = filtered_df_smallcase['Invested Amount'].str.upper()
